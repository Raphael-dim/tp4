...
import { TextField, Button, Typography, FormControlLabel, Switch, Select, MenuItem, InputLabel, FormControl } from "@mui/material";
  ...
  return (
    <div style={{ maxWidth: 600, margin: "auto" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button type="submit" onClick={handleDeleteProfile}>Supprimer mon compte</Button>
      </form>
    </div>
  );
}
